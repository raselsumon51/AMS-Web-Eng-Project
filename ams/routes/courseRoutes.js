...
const { showCourses, addTeacher, getAllCourses, showAllCourses, createCourse, createNewCourse, addCourseTeacher, teachersCourses } = require('../controllers/courseController');
const app = express();
...
router.get('/all-courses', showCourses);
router.post('/add/teacher', addTeacher);
router.get('/all', getAllCourses);
router.get('/all/show', showAllCourses);
router.get('/create', createCourse);
router.post('/create', createNewCourse);
router.get('/add/teacher', addCourseTeacher);
